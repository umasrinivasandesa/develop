...
function invokeGetDashboardMenuItems(){
  ...
  var headers = {"apikey": mfConfigParams.API_KEY};
  var reqParams = {};
  if(!isEmpty(integrationClient)){
...
function buildGeneralSegData(menuTab){
  ...
  if(genDataObj != null){
    ...
    frmDashboard.segGeneral.widgetDataMap = {"MenuId":"MenuId",
    ...
    frmDashboard.segGeneral2.widgetDataMap = {"MenuId":"MenuId",
                                              "lblMenuItemDesc":"Description",
                                              "lblSeparatorLine":"lblSeparatorLine",
                                              "flxGeneralMenu":"flxGeneralMenu",
                                              "ButtonOrder":"ButtonOrder",
    ...
    for(var j=0;j<subMenulen;j++){
      ...
      subMenu[j].flxGeneralMenu = {visible:true};
    }
...
function buildControlDeskSegData(menuTab){
  ...
  if(menuTab != null && menuTab.length > 0){
    ...
    for(var i=0; i< dataLen;i++){
      ...
      menuTab[i].imgArrow = {src:"right_arrow.png",visible : true};
  ...
  if(genDataObj.length > 0){
    ...
    frmDashboard.segControlDesk.widgetDataMap = {"TabOrder":"TabOrder",
                                                 "MenuId":"MenuId",
                                                 "lblMenuItemDesc":"Description",
                                              	 "lblSeparatorLine":"lblSeparatorLine",                                             
                                                 "subMenu":"subMenu",
...
function onClickGeneralSeg(segmentObj){
  ...
  if(selectedName == "AMS"){
    ...
    var urlConfig = {URL: urlInfo, requestMethod:constants.BROWSER_REQUEST_METHOD_GET};
...
function buildCDSubMenuList(subMenu){
  if(subMenu != null && subMenu.length > 0){
    ...
    for(var j=0;j<subMenulen;j++){
      subMenu[j].lblSeparatorLine = " ";
      subMenu[j].flxSubMenu = {visible:true};
      
      subMenu[j].imgArrow = {src:"right_arrow.png",visible : true};
    }
    
    frmDashboard.segSubMenu.widgetDataMap = {"MenuId":"MenuId",
                                              "lblMenuItemDesc":"Description",
                                              "lblSeparatorLine":"lblSeparatorLine",
